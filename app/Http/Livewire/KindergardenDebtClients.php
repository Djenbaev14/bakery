...
final class KindergardenDebtClients extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    ...
    */
    ...
    {
        return Client::query()->where('kindergarden','=',1);
    }
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('client_balance', fn (Client $model) => number_format(client_balance($model->id)).' сум');
    }
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Сумма', 'client_balance')
                ->sortable(),
